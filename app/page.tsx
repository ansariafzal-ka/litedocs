...
const page = async () => {
  ...
  return (
    <main className="w-full h-screen bg-[#020E1C] flex justify-center items-center">
      <div className="w-[325px] sm:w-fit text-center flex flex-col gap-5 bg_secondary p-5 rounded-md">
        <div className="sm:w-[400px] text-center">
          <h1 className="mb-1 text-xl font-medium">Welcome to LiteDocs</h1>
